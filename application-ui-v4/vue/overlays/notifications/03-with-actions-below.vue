          ...
          <div class="p-4">
            <div class="flex items-start">
              ...
              <div class="ml-3 w-0 flex-1 pt-0.5">
                <p class="text-sm font-medium text-gray-900 dark:text-white">Discussion moved</p>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit oluptatum tenetur.</p>
