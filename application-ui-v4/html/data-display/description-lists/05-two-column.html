  ...
  <div class="mt-6">
    <dl class="grid grid-cols-1 sm:grid-cols-2">
      ...
      <div class="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0 dark:border-white/10">
        ...
        <dd class="mt-1 text-sm/6 text-gray-700 sm:mt-2 dark:text-gray-400">Backend Developer</dd>
      </div>
      <div class="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0 dark:border-white/10">
        <dt class="text-sm/6 font-medium text-gray-900 dark:text-white">Email address</dt>
        <dd class="mt-1 text-sm/6 text-gray-700 sm:mt-2 dark:text-gray-400">margotfoster@example.com</dd>
      </div>
      <div class="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0 dark:border-white/10">
      ...
      <div class="border-t border-gray-100 px-4 py-6 sm:col-span-2 sm:px-0 dark:border-white/10">
        ...
        <dd class="mt-1 text-sm/6 text-gray-700 sm:mt-2 dark:text-gray-400">Fugiat ipsum ipsum deserunt culpa aute sint do nostrud anim incididunt cillum culpa consequat. Excepteur qui ipsum aliquip consequat sint. Sit id mollit nulla mollit nostrud in ea officia proident. Irure nostrud pariatur mollit ad adipisicing reprehenderit deserunt qui eu.</dd>
      </div>
      <div class="border-t border-gray-100 px-4 py-6 sm:col-span-2 sm:px-0 dark:border-white/10">
