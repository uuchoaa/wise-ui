<div class="bg-white shadow-sm sm:rounded-lg dark:bg-gray-800/50 dark:shadow-none dark:outline dark:-outline-offset-1 dark:outline-white/10">
  <div class="px-4 py-5 sm:p-6">
    ...
    <div class="mt-5">
      <div class="rounded-md bg-gray-50 px-6 py-5 sm:flex sm:items-start sm:justify-between dark:bg-gray-800">
        <h4 class="sr-only">Visa</h4>
        <div class="sm:flex sm:items-start">
          <svg viewBox="0 0 36 24" aria-hidden="true" class="h-8 w-auto sm:h-6 sm:shrink-0">
          ...
          <div class="mt-3 sm:mt-0 sm:ml-4">
            ...
            <div class="mt-1 text-sm text-gray-600 sm:flex sm:items-center dark:text-gray-400">
              ...
              <span aria-hidden="true" class="hidden sm:mx-2 sm:inline">&middot;</span>
              <div class="mt-1 sm:mt-0">Last updated on 22 Aug 2017</div>
            </div>
          </div>
        </div>
        <div class="mt-4 sm:mt-0 sm:ml-6 sm:shrink-0">
          <button type="button" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 dark:bg-white/10 dark:text-white dark:shadow-none dark:ring-white/5 dark:hover:bg-white/20">Edit</button>
        </div>
      </div>
    </div>
  </div>
