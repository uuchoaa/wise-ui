      ...
      <div class="mt-10 space-y-10 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:border-t-gray-900/10 sm:pb-0 dark:border-white/10 dark:sm:divide-white/10 dark:sm:border-t-white/10">
        <fieldset>
          ...
          <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:py-6">
            <div aria-hidden="true" class="text-sm/6 font-semibold text-gray-900 dark:text-white">By email</div>
        ...
        <fieldset>
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-baseline sm:gap-4 sm:py-6">
            <div aria-hidden="true" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Push notifications</div>
