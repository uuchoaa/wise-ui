...
<header class="relative bg-white shadow-sm dark:bg-gray-800/50 dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10">
  <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8 dark:lg:divide-white/10">
    <div class="relative flex h-16 justify-between">
      ...
      <div class="relative z-0 flex flex-1 items-center justify-center px-2 sm:absolute sm:inset-0">
        <div class="grid w-full grid-cols-1 sm:max-w-xs">
          <input name="search" placeholder="Search" class="col-start-1 row-start-1 block w-full rounded-md bg-white py-1.5 pr-3 pl-10 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" />
    ...
    <nav aria-label="Global" class="hidden lg:flex lg:space-x-8 lg:py-2">
      <!-- Current: "bg-gray-100 dark:bg-gray-950/50 text-gray-900 dark:text-white", Default: "text-gray-900 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 dark:hover:text-white" -->
      <a href="#" aria-current="page" class="inline-flex items-center rounded-md bg-gray-100 px-3 py-2 text-sm font-medium text-gray-900 dark:bg-gray-950/50 dark:text-white">Dashboard</a>
      <a href="#" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white">Team</a>
      <a href="#" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white">Projects</a>
      <a href="#" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white">Calendar</a>
    </nav>
  </div>
  ...
  <el-disclosure id="mobile-menu" hidden class="contents lg:hidden">
    <nav aria-label="Global">
      <div class="space-y-1 px-2 pt-2 pb-3">
        <!-- Current: "bg-gray-100 dark:bg-white/5 text-gray-900 dark:text-white", Default: "text-gray-900 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 dark:hover:text-white" -->
        <a href="#" aria-current="page" class="block rounded-md bg-gray-100 px-3 py-2 text-base font-medium text-gray-900 dark:bg-white/5 dark:text-white">Dashboard</a>
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white">Team</a>
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white">Projects</a>
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white">Calendar</a>
      </div>
      <div class="border-t border-gray-200 pt-4 pb-3 dark:border-white/10">
        ...
        <div class="mt-3 space-y-1 px-2">
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">Your profile</a>
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">Settings</a>
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">Sign out</a>
        </div>
      </div>
    </nav>
  </el-disclosure>
