    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
      <li>
        <ul role="list" class="-mx-2 space-y-1">
          <li>
            <!-- Current: "bg-indigo-700 dark:bg-black/10 text-white", Default: "text-indigo-200 dark:text-indigo-100 hover:text-white hover:bg-indigo-700 dark:hover:bg-black/10" -->
            <a href="#" class="group flex gap-x-3 rounded-md bg-indigo-700 p-2 text-sm/6 font-semibold text-white dark:bg-black/10">
              ...
              Dashboard
              <span aria-hidden="true" class="ml-auto w-9 min-w-max rounded-full bg-indigo-600 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-white outline-1 -outline-offset-1 outline-indigo-500 dark:bg-indigo-800 dark:outline-indigo-600/75">5</span>
            </a>
          </li>
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
          ...
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
              ...
              Projects
              <span aria-hidden="true" class="ml-auto w-9 min-w-max rounded-full bg-indigo-600 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-white outline-1 -outline-offset-1 outline-indigo-500 dark:bg-indigo-800 dark:outline-indigo-600/75">12</span>
            </a>
          </li>
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
              ...
              Calendar
              <span aria-hidden="true" class="ml-auto w-9 min-w-max rounded-full bg-indigo-600 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-white outline-1 -outline-offset-1 outline-indigo-500 dark:bg-indigo-800 dark:outline-indigo-600/75">20+</span>
            </a>
          </li>
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
      ...
      <li>
        ...
        <ul role="list" class="-mx-2 mt-2 space-y-1">
          <li>
            <!-- Current: "bg-indigo-700 dark:bg-black/10 text-white", Default: "text-indigo-200 dark:text-indigo-100 hover:text-white hover:bg-indigo-700 dark:hover:bg-black/10" -->
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
              <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-indigo-400 bg-indigo-500 text-[0.625rem] font-medium text-white dark:border-indigo-500 dark:bg-indigo-700">H</span>
              <span class="truncate">Heroicons</span>
            </a>
          </li>
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
              <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-indigo-400 bg-indigo-500 text-[0.625rem] font-medium text-white dark:border-indigo-500 dark:bg-indigo-700">T</span>
              <span class="truncate">Tailwind Labs</span>
            </a>
          </li>
          <li>
            <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-indigo-200 hover:bg-indigo-700 hover:text-white dark:text-indigo-100 dark:hover:bg-black/10">
              <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-indigo-400 bg-indigo-500 text-[0.625rem] font-medium text-white dark:border-indigo-500 dark:bg-indigo-700">W</span>
