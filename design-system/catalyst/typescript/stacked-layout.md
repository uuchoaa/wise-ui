...
You don't have enough features to fill a sidebar anyway, plus they aren't going to be cool forever.[Open in new tab](/demos/stacked)
...
|  |`navbar``Navbar`
| - | The | menu for desktop screen sizes. |`sidebar``Sidebar`
